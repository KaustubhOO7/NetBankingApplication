...
public class ControllerClass {
	...
	public String requestMoney(Model m) throws Exception
	{
        String email = (String) session.getAttribute("currentUser");
	...
	public String changePassword(Model m) throws Exception
	{
		String email = (String) session.getAttribute("currentUser");
		if(serviceClass.loginCheck(email)==true)
		{
	...
	@GetMapping("ForgotPassword0")
	public String getForgetPassword(Model m) throws Exception
	{
		String email = (String) session.getAttribute("currentUser");
		if(serviceClass.loginCheck(email)==true)
		{
	...
	@GetMapping("requestMoney")
	public String getRequestMoney(Model m) throws Exception
	{
		String email = (String) session.getAttribute("currentUser");
		if(serviceClass.loginCheck(email)==true)
		{
